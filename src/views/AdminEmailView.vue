<template>
  <div class="container mt-4">
    ...
    <p class="lead">Send emails with an optional attachment via SendGrid (Cloudflare Function).</p>

    <form @submit.prevent="onSend" class="mt-3">
      <div class="mb-3">
        <label class="form-label">Recipient Email</label>
        <input v-model.trim="to" type="email" class="form-control" required placeholder="someone@example.com" />
      </div>
